const CACHE='xray-grr-v10-optimizer-full-data-scope';
const ASSETS=['./','./index.html','./styles.css','./ui.css','./parser-shim.js','./core.js','./app.js','./ui.js','./study-mode.js','./optimizer.js','./manifest.webmanifest','./icon.svg'];
